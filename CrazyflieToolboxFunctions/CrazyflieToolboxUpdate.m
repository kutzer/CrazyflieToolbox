function CrazyflieToolboxUpdate
% CRAZYFLIETOOLBOXUPDATE download and update the Crazyflie Toolbox. 
%
%   M. Kutzer 27Jan2017, USNA

% TODO - Find a location for "CrazyflieToolbox Example SCRIPTS"

% Update Plotting Toolbox
ToolboxUpdate('Crazyflie');
